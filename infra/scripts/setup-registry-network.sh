...
echo ""
echo "To persist across reboots, the gpt-dev-registry-rules systemd service"
echo "  re-applies these rules after Docker starts on boot."
echo "  On systems with iptables-persistent (pre-Ubuntu 26.04), use:"
